...
class InputLayer(Layer):
    def __init__(self, placeholders, **kwargs):
        ...
        with tf.variable_scope(self.name + '_vars'):
            self.vars['obj_v_proj'] = uniform(shape=[2048, 300], trainable=True, name='obj_v_proj')
            self.vars['ocr_bbox_proj'] = uniform(shape=[8, 300], trainable=True, name='ocr_bbox_proj')
