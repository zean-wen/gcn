...
placeholders = {
    'support': [tf.sparse_placeholder(tf.float32) for _ in range(num_supports)],
    'object_name_embeddings': tf.placeholder(tf.float32, shape=(None, None)),
    'object_visual_features': tf.placeholder(tf.float32, shape=(None, None)),
    'ocr_token_embeddings': tf.placeholder(tf.float32, shape=(None, None)),
    'ocr_bounding_boxes': tf.placeholder(tf.float32, shape=(None, None)),
    'labels': tf.placeholder(tf.float32, shape=(None, y_train.shape[1])),
    'labels_mask': tf.placeholder(tf.int32),
    'dropout': tf.placeholder_with_default(0., shape=()),
    'num_features_nonzero': tf.placeholder(tf.int32)  # helper variable for sparse dropout
